...
set analog_sel "resname AAA and not hydrogen"
set psffile "analog-AAA.psf"
...
for {set i 0} {$i < $nframes} {incr i} {
    ...
    foreach r1 $reslist {
        set sel1 [atomselect top "$analog_sel and resid $r1 and not hydrogen"]
        foreach r2 $reslist {
            if {$r2 <= $r1} {continue}
            set sel2 [atomselect top "$analog_sel and resid $r2 and not hydrogen"]
